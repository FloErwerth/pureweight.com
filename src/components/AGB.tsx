  ...
  return (
    ...
    >
      <p>
        ...
        <p>
          These General Terms and Conditions (hereinafter: GTC) establish the legal framework for
          the use of the Pure Weight app, unless otherwise agreed.
        </p>
        <p>
          The Pure Weight app (hereinafter: app) is a strength training app that allows you to
          record and evaluate your training.
        </p>
        ...
        <p>
          The app is fully available to all users, if the required subscription has been concluded
          in the App Store.
        </p>
        <p>
          The exact scope of services of the app can be found in the app description in the Apple
          App Store (hereinafter: App Store) in the version valid at the time of conclusion of the
          contract.
        </p>
        <h3>2.2. Changes to the scope of services</h3>
        <p>
          The provider reserves the right to change the scope of services of the app, in particular
        ...
        <p>
          ...
          conditions are suitable for training with the app. This applies especially if you know
          that you have one or more of the following complaints / interventions / illnesses:
        </p>
        <p>
        ...
        <p>
          ...
          You only have a simple and non-transferable right to use these protected contents
          privately within the framework of the contractual provisions and you are not allowed to
          pass on your access data to third parties.
        </p>
        ...
        <p>
          For a subscription with a term of one month, the payment is due in advance at the
          beginning of the billing month.
        </p>
        <p>
        ...
        <p>
          ...
          without giving any reason. The withdrawal period is fourteen days from the day the
        ...
        <p>
          ...
          have chosen a different type of delivery than the cheapest standard delivery offered by
          us), immediately and at the latest within (14) fourteen days from the day on which we
          receive notification of your withdrawal from the contract. For this repayment, we will use
        ...
        <p>
          ...
          content not on a physical data carrier, even if we have begun to execute the contract
          after you have expressly agreed that we begin to execute the contract before the end of
          the withdrawal period and you have confirmed your knowledge that you lose your right of
        ...
        <p>
          ...
          <p>
            ...
            following goods (*) /the provision of the following service (*) - Ordered on (*)
            /received on (*) - Name of the consumer(s) - Address of the consumer(s) - Signature of
            the consumer(s) (only in the case of communication on paper) Date _______ (*) Delete as
            applicable.
          </p>
        </p>
        ...
        <p>
          Your subscription is automatically extended by another month for a subscription with a
          term of one month or by another twelve months for a subscription with a term of twelve
          months, if you do not cancel your subscription in the settings of the App Store at least
          24 hours before the end of the contract.
        </p>
        <p>
          After an effective cancellation, your subscription remains in effect until the end of the
          contract. During this time you can continue to use the app. Afterwards you will be
        ...
        <p>
          ...
          above provisions. We reserve the right to terminate your subscription if you are in
          default of payment.
        </p>
        ...
        <p>
          We do not guarantee that you will achieve your training goals by using the app. The
          training result is also influenced by uncontrollable factors such as your genetic
          predisposition. It can therefore happen that different people achieve different results
          with the same use of the app.
        </p>
        ...
        <p>
          If you do not have a general place of jurisdiction in Germany or in another EU member
          state or if you have moved your permanent residence to a country outside the EU after
          these General Terms and Conditions have become effective or if your place of residence or
          habitual abode is not known at the time of filing the action, the exclusive place of
        ...
        <p>
          ...
          the opportunity to settle disputes related to your online order without going to court.
          You can find the dispute resolution platform here: https://ec.europa.eu/consumers/odr We
          are neither obliged nor willing to participate in a dispute resolution procedure before a
  ...
  const german = (
    ...
    >
      <p>
        ...
        <p>
          Der Anbieter behält sich das Recht vor, den Leistungsumfang der App zu ändern,
        ...
        <p>
          ...
          körperlichen Voraussetzungen für das Training mit der App geeignet sind. Das gilt vor
          allem dann, wenn du weißt, dass du eine oder mehrere der folgenden Beschwerden / Eingriffe
          / Erkrankungen hast bzw. hattest:
        </p>
        <p>
          <li>Gelenkprobleme </li>
          <li>operative Eingriffe</li> <li>kardiovaskuläre Erkrankungen </li>
        ...
        <p>
          Uns stehen die Rechte der urheberrechtlich oder anderweitig geschützten Inhalte der App
          zu. Du hast lediglich ein einfaches und nicht-übertragbares Recht, diese geschützten
          Inhalte privat im Rahmen der Vertragsbestimmungen zu nutzen und darfst deine Zugangsdaten
        ...
        <p>
          ...
          Tagen ohne Angabe von Gründen den Vertrag zu widerrufen. Die Widerrufsfrist beträgt
          vierzehn Tage ab dem Tag des Vertragsschlusses.
        </p>
        <p>
          Um dein Widerrufsrecht auszuüben, musst du dein Abonnement innerhalb der Frist von
          vierzehn Tagen im App Store kündigen.
        </p>
        <p>
        ...
        <p>
          Machst du von dieser Möglichkeit Gebrauch, so werden wir dir unverzüglich (z.B. per
          E‑Mail) eine Bestätigung über den Eingang eines solchen Widerrufs übermitteln. Zur Wahrung
        ...
        <p>
          ...
          günstigste Standardlieferung gewählt hast), unverzüglich und spätestens binnen (14)
          vierzehn Tagen ab dem Tag zurückzuzahlen, an dem die Mitteilung über deinen Widerruf des
        ...
        <p>
          Dein Abonnement verlängert sich automatisch um einen weiteren Monat bei einem Abonnement
          mit einer Laufzeit von einem Monat oder um weiter zwölf Monate bei einem Abonnement mit
          einer Laufzeit von zwölf Monaten, wenn du dein Abonnement nicht spätestens bis 24 Stunden
          vor dem Vertragsende in den Einstellungen des App Stores kündigst.
        </p>
        <p>
          Nach einer wirksamen Kündigung bleibt dein Abonnement bis zum Vertragsende bestehen.
          Während dieser Zeit kannst du die App weiter benutzen. Anschließend wirst Du von der
          Nutzung der App ausgeschlossen.
        </p>
        <p>
        ...
        <p>
          ...
          vorstehenden Regelungen unberührt bleibt. Wir behalten uns vor dein Abonnement zu
          kündigen, wenn Du in Zahlungsverzug bist.
        </p>
        <h2>8. Datenschutz</h2>
        <p>
          Bei der Nutzung der App verarbeiten keine personenbezogenen Daten. Diese
          Datenschutzerklärung klärt dich über die Art und den Umfang der Datenerhebung auf und
          zeigt dir wie wir deine Daten nutzen.
        </p>
        <h2>9. Haftung</h2>
        <h3>9.1. Allgemein</h3>
        <p>
          Von der App werden keine Empfehlungen bezüglich der Ausführung der von Dir gespeicherten
          Übungen gegeben. Die App dient lediglich der Dokumentation deiner Trainingsleistungen.
          Daher übernehmen wir keine Haftung für Schäden, die durch die Ausführung der von dir
          gespeicherten Übungen entstehen.
        </p>
        ...
        <p>
          ...
          erreichst. Das Trainingsergebnis wird nämlich auch durch nicht steuerbare Faktoren wie
          z.B. deine genetischen Voraussetzungen beeinflusst. Dementsprechend kann es dazu führen,
          dass bei gleicher Nutzung der App, verschiedene Personen unterschiedliche Ergebnisse
          erzielen.
        </p>
        ...
        <p>
          ...
          widersprechen. Außerdem werden wir dich darauf hinweisen, dass die Änderungen bei
