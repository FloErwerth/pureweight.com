...
export const PrivacyContent = () => {
  ...
  return <GermanPrivacyContent />;
};

export const GermanPrivacyContent = () => {
  return (
    <div className="flex flex-col gap-10">
      <p>
        <p>
          <h2>1. Verantwortlicher</h2> Der Verantwortliche im Sinne der Datenschutz-Grundverordnung
        ...
        <p>
          ...
          <p>
            Auch wenn Pure Weight keine Daten verarbeitet sind wir verpflichtet die Rechtsgrundlage
            für die Verarbeitung personenbezogener Daten anzugeben.
            <br />
            ...
            Einwilligung einholen, dient Art. 6 Abs. 1 lit. a EU-Datenschutzgrundverordnung (DSGVO)
            als Rechtsgrundlage. Bei der Verarbeitung von personenbezogenen Daten, die zur Erfüllung
            eines Vertrages, dessen Vertragspartei du bist, erforderlich ist, dient Art. 6 Abs. 1
            ...
            personenbezogener Daten zur Erfüllung einer rechtlichen Verpflichtung erforderlich ist,
            der unser Unternehmen unterliegt, dient Art. 6 Abs. 1 lit. c DSGVO als Rechtsgrundlage.
            Für den Fall, dass lebenswichtige Interessen von dir oder einer anderen natürlichen
            Person eine Verarbeitung personenbezogener Daten erforderlich machen, dient Art. 6 Abs.
            1 lit. d DSGVO als Rechtsgrundlage. Ist die Verarbeitung zur Wahrung eines berechtigten
            Interesses unseres Unternehmens oder eines Dritten erforderlich und überwiegen deine
            Interessen, Grundrechte und Grundfreiheiten das erstgenannte Interesse nicht, so dient
          ...
          <p>
            ...
            der App eingibst, ist Art. 6 Abs. 1 lit. b DSGVO, da die Erhebung dieser Daten im Rahmen
            der Erfüllung eines Vertrages, dessen Vertragspartei der Nutzer ist oder der
          ...
          <p>
            Die Datenschutzerklärung von Apple ist hier zu finden: https://www.apple.com/de/privacy{" "}
            <br />
          ...
          <p>
            Die Verarbeitung der personenbezogenen Daten dient der Abwicklung des Abonements und der
            Zahlung.
          </p>
          <h3>4.4. Dauer der Speicherung</h3>
          <p>
            Die Dauer der Datenspeicherung findest Du in der Datenschutzerklärung von Apple bzw. in
            der Datenschutzerklärung von RevenueCat. Die Datenschutzerklärung von Apple ist hier zu
            finden: https://www.apple.com/de/privacy Die Datenschutzerklärung von RevenueCat ist
            hier zu finden: https://www.revenuecat.com/privacy
          </p>
          ...
          <p>
            Unsere Website benutzt Google Fonts Schriftarten (Google LLC, 1600 Amphitheatre Parkway,
            Mountain View, CA 94043, USA). Die Datenschutzerklärung des Anbieters ist hier zu
          ...
          <p>
            ...
            <li>
              die geplante Dauer der Speicherung der dich betreffenden personenbezogenen Daten oder,
            ...
            <li>
              ...
              Daten nicht bei dir erhoben werden
            </li>
            <li>
          ...
          <p>
            ...
            Verantwortlichen, sofern die verarbeiteten personenbezogenen Daten, die dich betreffen,
          ...
          <p>
            ...
            <li>
              ...
              länger benötigt, du sie jedoch zur Geltendmachung, Ausübung oder Verteidigung von
          ...
          <p>
            ...
            dürfen diese Daten – von ihrer Speicherung abgesehen – nur mit deiner Einwilligung oder
          ...
          <p>
            ...
            zutrifft:
            <li>
              Die dich betreffenden personenbezogenen Daten sind für die Zwecke, für die sie erhoben
            ...
            <br />
            Hat der Verantwortliche die dich betreffenden personenbezogenen Daten öffentlich gemacht
            ...
            personenbezogenen Daten verarbeiten, darüber zu informieren, dass du als betroffene
            ...
            <p>
              ...
              aufgrund von Art. 6 Abs. 1 lit. e oder f DSGVO erfolgt, Widerspruch einzule gen; dies
              gilt auch für ein auf diese Bestimmungen gestütztes Profiling. Der Verantwortliche
              verarbeitet die dich betreffenden personenbezogenen Daten nicht mehr, es sei denn, er
              kann zwingende schutzwürdige Gründe für die Verarbeitung nachweisen, die deine
              Interessen, Rechte und Freiheiten überwiegen, oder die Verarbeitung dient der
              Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen. Werden die dich
              betreffenden personenbezogenen Daten verarbeitet, um Direktwerbung zu betreiben, hast
              du das Recht, jederzeit Widerspruch gegen die Verarbeitung der dich betreffenden
              personenbezogenen Daten zum Zwecke derartiger Werbung einzulegen; dies gilt auch für
              das Profiling, soweit es mit solcher Direktwerbung in Verbindung steht. Widersprichst
              du der Verarbeitung für Zwecke der Direktwerbung, so werden die dich betreffenden
              personenbezogenen Daten nicht mehr für diese Zwecke verarbeitet. Im Zusammenhang mit
              der Nutzung von Diensten der Informationsgesellschaft kannst du ungeachtet der
              Richtlinie 2002/58/EG dein Widerspruchsrecht mittels automatisierter Verfahren
            ...
            <p>
              ...
              auf Erwirkung des Eingreifens einer Person seitens des Verantwortlichen, auf Darlegung
...
export const EnglishPrivacyContent = () => {
  return (
    <>
      <div className="flex flex-col gap-10">
        <p>
